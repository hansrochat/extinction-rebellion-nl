...
<section class="hero text-white py-5" style="background: linear-gradient(rgba(0, 0, 0, 0.35), rgba(0, 0, 0, 0.95)), url('https://extinctionrebellion.nl/app/uploads/2021/02/143304662_454786392563007_4345810537040199100_o.jpg') no-repeat center center / cover;">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="content col-12 col-sm-10 col-md-8 col-lg-8 col-xl-7 mx-auto">
        ...
        <div class="row">
          <div class="mx-auto">
            <a class="btn btn-lg btn-green" href="https://www.whydonate.nl/fundraising/help-extinction-rebellion-nederland">Doneer</a>
          </div>
          </div>
      </div>
    </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="content col-12 col-sm-10 col-md-8 col-lg-8 col-xl-7 mx-auto">
        ...
        <h3>Waarom periodiek schenken?</h3>
        <ul>
        ...
        <h3>Meer weten?</h3>
        <ul>
          <li><a href="https://extinctionrebellion.nl/app/uploads/2021/01/schenken-informatie-over-periodiek-schenken.pdf">Aanvullende informatie over periodiek schenken (PDF)</a></li>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="content col-12 col-sm-10 col-md-8 col-lg-8 col-xl-7 mx-auto">
        ...
        <p>NL86 SNSB 0783 1486 74 t.n.v. Stichting Vrienden van XR</p>
      </div>
    </div>
  </div>
</section>
...
<section>
  <div class="container-fluid">
    <div class="row">
      <div class="content col-12 col-sm-10 col-md-8 col-lg-8 col-xl-7 mx-auto text-center">
        <h2>Waar geven wij jou bijdrage aan uit?</h2>
        <img src="https://extinctionrebellion.nl/app/uploads/2021/07/uitgaven_2020.jpg" alt="XR Nederland Uitgaven 2020">
        <p class="text-center">
          <a href="https://extinctionrebellion.nl/stichting-vrienden-van-xr/">Meer weten over inkomsten en uitgaven van Extinction Rebellion NL?</a>
        </p>
      </div>
    </div>
  </div>
