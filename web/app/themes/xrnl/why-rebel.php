...
<main class="why-rebel">
  ...
  <section id="calls-to-action" class="container-fluid">
    <div class="row">
      <div class="content col-12 col-sm-10 col-md-8 col-lg-8 col-xl-7 mx-auto">
        <div class="ctas">
        <a class="cta btn btn-lg btn-green" href="<?php echo $section->button_cta['url'] ?>" onclick="<?php register_button_click($section->button_cta['label']); ?>">
            <?php echo $section->button_cta['label'] ?>
          </a>
          <a class="cta link" href="<?php echo $section->link_cta['url'] ?>" onclick="<?php register_button_click($section->link_cta['label']); ?>">
